...
| 19a | **Schulbarometer-Zahlen belegen.** Das Band „Warum es uns gibt" nennt 83 %, über 75 % und 84 % – paraphrasiert nach dem Deutschen Schulbarometer. Die Werte stammen aus dem Auftrag und konnten nicht gegen die Veröffentlichung geprüft werden; das Schulbarometer erscheint in mehreren Wellen mit unterschiedlichen Werten. Vor dem Livegang die Welle bestimmen und die Jahreszahl in der Quellenzeile ergänzen | [why-we-exist.tsx](src/components/sections/why-we-exist.tsx) | Inhalt + Recht  |
